...
##' @param groupLabel a vector of mode \code{character} that contains
...
barMonophyletic <- function(groupLabel, tree, cex.plot, cex.text=.8, include.tip.label=FALSE,
  ...
  ## TODO: it would be nice that groupLabel be split in 2 arguments: 1 for the labels
  ##  per se and another for identifying the monophyletic groups.
